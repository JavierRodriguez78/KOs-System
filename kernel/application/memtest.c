...
void app_memtest(void) {
    ...
    kos_printf((int8_t*)"memmove forward overlap %s\n", ok1 ? (int8_t*)"OK" : (int8_t*)"FAIL");
    ...
    kos_printf((int8_t*)"memmove backward overlap %s\n", ok2 ? (int8_t*)"OK" : (int8_t*)"FAIL");
